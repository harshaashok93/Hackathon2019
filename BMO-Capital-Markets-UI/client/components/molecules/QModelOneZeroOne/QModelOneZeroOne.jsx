...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
import './QModelOneZeroOne.scss';

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// Component Definition
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

class QModelOneZeroOne extends Component {
  props: {
    MonthlyOverviewText: '',
    onSubmit: () => void
  };
  ...
  state = {
    subMenuExpand: false,
    subMenu: [{ name: 'sub1', val: '2016' }, { name: 'sub1', val: '2016' }, { name: 'sub1', val: '2016' }],
  ...
  subMenuClick = (e) => {
    ...
    this.props.onSubmit({ type: 'GET_TEXT', text: `Q Model One Zero - ${index}` });
  }
  render() {
    ...
    return (
      <div className="q-model-monthly-overview q-model-accordion ui fluid accordion">
        <div className={`menu ${subMenuExpand.toString()}`} >
          <Label className={'menu-title filter-name'} as={NavLink} to={'/q-model-101/'} content={MonthlyOverviewText} onClick={this.expandSubMenu} />
...
export default connect(mapStateToProps, mapDispatchToProps)(QModelOneZeroOne);
